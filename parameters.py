...
qp_path_pre = './data/qp.hdf5' # Path to save queries and paths.
...
# Model parameters #
####################
qp_path = './data/queries_paths_jeopardy.hdf5' # Path to load queries and paths.
...
scoring_layers_nav=[] # list containing the number of hidden units in each intermediate scoring layer of the navigation loop. Set to [] if you want only one scoring layer.
...
reload_model='./data/model_wikinav-jeopardy.npz'  # Path to a saved model we want to start from.
