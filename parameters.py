...
pages_path = '../data/wiki_171_24810.hdf5' # Path to save the articles and links.
pages_emb_path = '../data/wiki_emb_171_24810.hdf5' # Path to save articles embeddings (set to None to not compute it).
qp_path_pre = '../data/qp_171_24810.hdf5' # Path to save queries and paths.
